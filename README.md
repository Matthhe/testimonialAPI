...
Запускает 21 интеграционных тестов (Jest + Supertest + in-memory MongoDB).  
Покрытие: аутентификация, CRUD отзывов, валидация переходов, шаринг, аналитика, права доступа, случаи в сфере безопасности.
