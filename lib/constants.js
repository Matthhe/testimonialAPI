...
const DEFAULT_VIDEO_LENGTH_OPTIONS = [5, 10, 15, 20, 25];
const DEFAULT_QUESTIONNAIRE = ['What do you like about our service?'];
const DEFAULT_SENDING_OPTIONS = ['email', 'sms'];
